...
namespace web.Controllers
{
    ...
    public class ReclamoController : Controller
    {
        ...
        public ActionResult Imprimir(DateTime? fecha_ini, DateTime? fecha_fin)
        {
        ...
        [ValidateInput(false)]
        public ActionResult GridViewPartial_reclamos(DateTime? fecha_ini, DateTime? fecha_fin)
        {
            ViewBag.lst_queja = odata.get_list(fecha_ini, fecha_fin);
            tbl_queja_Info model = new tbl_queja_Info
            {
                fecha_ini = fecha_ini,
                fecha_fin = fecha_fin
