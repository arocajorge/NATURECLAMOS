...
namespace Cons
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //aTimer.Interval = TimeSpan.FromHours(24).TotalMilliseconds;
            aTimer.Interval = TimeSpan.FromSeconds(30).TotalMilliseconds;
            aTimer.Enabled = true;

            Console.WriteLine("Presiona \'q\' para terminar la aplicación.");
